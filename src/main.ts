...
export async function main(options: ICoreOptions) {
  ...
  coreContext.service(
    CoreBindings.CoreCommandsComponent,
    CoreCommandsComponent
  );
  coreContext.service(CoreBindings.CoreMessageComponent, CoreMessageComponent);

  // -- singletons
  await coreContext.component(
    CoreBindings.CoreWorkspaceComponent,
    CoreWorkspaceComponent
  );
  await coreContext.component(
    CoreBindings.CoreDocumentsComponent,
    CoreDocumentsComponent
  );
  await coreContext.component(
    CoreBindings.CoreLanguagesComponent,
    CoreLanguagesComponent
  );
  await coreContext.component(
    CoreBindings.CoreFileSystemWatcherComponent,
    CoreFileSystemWatcherComponent
  );
  await coreContext.component(
    CoreBindings.CoreConfigurationComponent,
  ...
  await coreContext.component(
    CoreBindings.CoreExtensionsComponent,
    ExtensionsComponent
  );
