...
export class Barrier {
  ...
  private _completePromise: ((v: boolean) => void) | undefined;
...
export function disposableTimeout(handler: (...args: any[]) => void, timeout = 0): IDisposable {
...
export class IdleValue<T> {
  ...
  private _didRun: boolean | undefined;
